...
#	plt.title("Heavy Hitters ARE")
	plt.xlim(0, 6)
	plt.xticks(range(1, 6), ("1M", "5M", "10M", "15M", "20M"))
	plt.plot(range(1, 6), are_sw, label = "Software", marker = "x")
	plt.plot(range(1, 6), are_hw, label = "Hardware", marker = "o")
...
#	plt.title("Heavy Hitters ARE")
	plt.xlim(0, 6)
	plt.xticks(range(1, 6), ("1M", "5M", "10M", "15M", "20M"))
	plt.plot(range(1, 6), f1score_sw, label = "Software", marker = "x")
	plt.plot(range(1, 6), f1score_hw, label = "Hardware", marker = "o")
#	plt.legend(bbox_to_anchor=(0.0, 1.02, 1.0, 0.102), loc = 3, ncol = 2, mode = "expand", borderaxespad = 0.0)
	plt.legend(loc = 1)
	plt.xlabel("Num. of Replayed Packets")
	plt.ylabel("ARE")
