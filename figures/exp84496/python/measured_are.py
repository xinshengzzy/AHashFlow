...
def func(n_pkts, resFile):
	...
	l = "\t".join([str(count), str(caida_ahf.measured_are(caida_flows)), str(caida_chf.measured_are(caida_flows)), str(hgc_ahf.measured_are(hgc_flows)), str(hgc_chf.measured_are(hgc_flows))])
	with open(resFile, "a") as f:
		f.write(l + "\n")

with open(resFile, "w") as f:
	f.write("n_pkts\tCAIDA-AHashFlow\tCAIDA-CHashFlow\tHGC-AHashFlow\tHGC-CHashFlow\n")
