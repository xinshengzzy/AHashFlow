...
#define EGRESS_ACL_KEY_L4_SPORT              l3_metadata.egress_l4_sport
#define EGRESS_ACL_KEY_L4_DPORT              l3_metadata.egress_l4_dport
...
action redirect_to_cpu_and_learn_inv(qid, meter_id, icos) {
    redirect_to_cpu(qid, meter_id, icos);
    invalidate_learn_digest();
}
 
action redirect_to_cpu_with_reason_and_learn_inv(reason_code, qid, meter_id, icos) {
    redirect_to_cpu_with_reason(reason_code, qid, meter_id, icos);
    invalidate_learn_digest();
}
