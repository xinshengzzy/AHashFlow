...
control process_int_watchlist_ {
    if ((valid(tcp) or valid(udp) or valid(icmp)) and ipv4.ihl == 5) {
        apply(int_watchlist);
    }
}
...
action int_sink_set_l45_dscp_clear_all(sink_bit) {
    modify_field(int_metadata.sink, sink_bit);
    intl45_set_dscp_all(0x00);
}
action int_sink_set_l45_dscp_clear_2(sink_bit) {
    modify_field(int_metadata.sink, sink_bit);
    intl45_set_dscp_2(0x00);
}
action int_sink_set_l45_dscp_clear_3(sink_bit) {
    modify_field(int_metadata.sink, sink_bit);
    intl45_set_dscp_3(0x00);
}
action int_sink_set_l45_dscp_clear_4(sink_bit) {
    modify_field(int_metadata.sink, sink_bit);
    intl45_set_dscp_4(0x00);
}
action int_sink_set_l45_dscp_clear_5(sink_bit) {
    modify_field(int_metadata.sink, sink_bit);
    intl45_set_dscp_5(0x00);
}
action int_sink_set_l45_dscp_clear_6(sink_bit) {
    modify_field(int_metadata.sink, sink_bit);
    intl45_set_dscp_6(0x00);
}
action int_sink_set_l45_dscp_clear_7(sink_bit) {
    modify_field(int_metadata.sink, sink_bit);
    intl45_set_dscp_7(0x00);
}

action int_convert_word_to_byte_l45_dscp_clear_all() {
    int_convert_word_to_byte();
    intl45_set_dscp_all(0x00);
}
action int_convert_word_to_byte_l45_dscp_clear_2() {
    int_convert_word_to_byte();
    intl45_set_dscp_2(0x00);
}
action int_convert_word_to_byte_l45_dscp_clear_3() {
    int_convert_word_to_byte();
    intl45_set_dscp_3(0x00);
}
action int_convert_word_to_byte_l45_dscp_clear_4() {
    int_convert_word_to_byte();
    intl45_set_dscp_4(0x00);
}
action int_convert_word_to_byte_l45_dscp_clear_5() {
    int_convert_word_to_byte();
    intl45_set_dscp_5(0x00);
}
action int_convert_word_to_byte_l45_dscp_clear_6() {
    int_convert_word_to_byte();
    intl45_set_dscp_6(0x00);
}
action int_convert_word_to_byte_l45_dscp_clear_7() {
    int_convert_word_to_byte();
    intl45_set_dscp_7(0x00);
}
...
table dtel_intl45_set_dscp {
    reads {
        egress_metadata.egress_port        : ternary;
