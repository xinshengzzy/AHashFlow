...
action ipv4_erspan_t3_rewrite_with_eth_hdr(smac, dmac, sip, dip, tos, ttl) {
...
action ipv4_erspan_t3_rewrite_with_eth_hdr_and_vlan_tag(smac, dmac, sip, dip, tos, ttl, vlan_tpid, vlan_id, cos) {
    f_insert_ipv4_erspan_t3_header(sip, dip, tos, ttl);
...
#else
action ipv4_erspan_t3_rewrite(sip, dip, tos, ttl) {
    f_insert_ipv4_erspan_t3_header(sip, dip, tos, ttl);
