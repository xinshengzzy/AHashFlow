...
#define SAI_API_MAX SAI_API_BRIDGE + 1
...
#define SAI_LOG_DEBUG(fmt, arg...) \
  bf_sys_log_and_trace(BF_MOD_SAI, BF_LOG_DBG, fmt, ##arg)

#define SAI_LOG_INFO(fmt, arg...) \
  bf_sys_log_and_trace(BF_MOD_SAI, BF_LOG_DBG, fmt, ##arg)

#define SAI_LOG_NOTICE(fmt, arg...) \
  bf_sys_log_and_trace(BF_MOD_SAI, BF_LOG_INFO, fmt, ##arg)

#define SAI_LOG_WARN(fmt, arg...) \
  bf_sys_log_and_trace(BF_MOD_SAI, BF_LOG_WARN, fmt, ##arg)

#define SAI_LOG_ERROR(fmt, arg...) \
  bf_sys_log_and_trace(BF_MOD_SAI, BF_LOG_ERR, fmt, ##arg)

#define SAI_LOG_CRITICAL(fmt, arg...) \
  bf_sys_log_and_trace(BF_MOD_SAI, BF_LOG_CRIT, fmt, ##arg)

#endif

// L2 learn timeout in milliseconds
#define SAI_L2_LEARN_TIMEOUT 50
