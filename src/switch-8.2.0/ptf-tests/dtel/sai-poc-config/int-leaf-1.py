...
params.switch_id = 0x1
params.mac_self = '8C:EA:1B:B7:D5:7E'
params.ipaddr_erspan_src = '10.14.20.48'
#params.ipaddr_erspan_dst = ['192.168.10.6']
...
@group('int_leaf_1')
class INT_LEAF_1(sai_base_test.ThriftInterfaceDataPlane):
    def runTest(self):
        print
