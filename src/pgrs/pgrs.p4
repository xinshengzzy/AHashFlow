...
blackbox stateful_alu alu1_1 {
    reg: r1;
    update_lo_1_value: register_lo + 10;
}
blackbox stateful_alu alu2 {
    reg: r2;
    update_lo_1_value: register_lo + 1;
}
blackbox stateful_alu alu2_1 {
    reg: r2;
    update_lo_1_value: register_lo + 10;
}
action a1() {
...
action a8() {
    alu1_1.execute_stateful_alu(13);
}
action a9() {
    alu2_1.execute_stateful_alu(ig_intr_md.ingress_port);
}
