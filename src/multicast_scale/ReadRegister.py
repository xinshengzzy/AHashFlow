...
import multicast_scale.p4_pd_rpc.multicast_scale as multicast_scale
...
p4_prefix = "multicast_scale"
p4_protocol = TMultiplexedProtocol.TMultiplexedProtocol(bprotocol, p4_prefix) 
client = multicast_scale.Client(p4_protocol)
flag = multicast_scale_register_flags_t(read_hw_sync = True)
...
'''
res = client.register_read_log(sess_hdl, dev_tgt, 0, flag)
print "cntr1:", res
'''
res = client.register_read_cntr2(sess_hdl, dev_tgt, 0, flag)
print "cntr2:", res
res = client.register_read_cntr3(sess_hdl, dev_tgt, 0, flag)
print "cntr3:", res
